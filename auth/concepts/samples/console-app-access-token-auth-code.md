...
1. Your external app will open the so called [authorize endpoint](../../../building-apps/concepts/how-apps-connect/identity-server.md) with your trusted app details (the trusted app, corresponding to your external app).

...
1. Your external app will navigate to the [authorize endpoint](../concepts/identity-server.md), passing your trusted app details (the trusted app, corresponding to your external app).

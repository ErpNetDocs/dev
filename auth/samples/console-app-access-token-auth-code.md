...
1. Your external app will open the so called [authorize endpoint](../concepts/identity-server.md) with your trusted app details (the trusted app, corresponding to your external app).

...
| **Invalid Scope** | `invalid_scope` | The requested scopes aren’t allowed for the app. | Verify the Trusted Application’s `Scope` field includes them. Example: `openid profile offline_access read`. |

...
1. The app authenticates to the @@name **Identity** with its `client_id` and `client_secret`.
2. @@name Identity validates the app against its **Trusted Application** record.

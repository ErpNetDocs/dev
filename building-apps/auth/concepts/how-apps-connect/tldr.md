...
2. It authenticates through **@@name Identity**, which verifies who's signing in.  
3. @@name Identity issues a **token** that defines what the app can access.  
...
2. Freddie opens the app and clicks **Sign In**. The app redirects him to **@@name Identity**, the secure login page of the instance.  
3. @@name Identity verifies Freddie's credentials and issues a **token** saying:  
...
**In short:**  
Brian's app connects to @@name through @@name Identity.  

...
Without this registration, @@name Identity Server will reject all authentication requests.
...
All external access must go through the @@name Identity Server using OAuth 2.0.
...
Each @@name Identity Server exposes a discovery document with full endpoint metadata:  

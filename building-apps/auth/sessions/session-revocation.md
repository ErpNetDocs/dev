...
- **User logout** – The user explicitly signs out via @@name Identity Server.  
...
Interactive applications using the **Authorization Code Flow** can explicitly end the user session via @@name Identity Server's logout endpoint.
...
- After confirmation, the Identity Server terminates the session.  

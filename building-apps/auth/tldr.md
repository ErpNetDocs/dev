...
2. It authenticates through the **@@name Identity**, which verifies who (or what) is signing in.  
...
All tokens are issued and verified by the instance's **@@name Identity** - no passwords are exchanged and no direct database access is needed.
...
2. When a sales rep logs in, the app redirects them to the **@@name Identity** - the official login portal.  
...
flowchart LR
  ...
  App -->|Auth Request| IDP[🛡️ ERP.net Identity]
...
- [**Trusted Applications and Access Control**](./concepts/how-apps-connect/trusted-apps-access.md)  
  See how app registrations define permissions and modes.

- [**Authentication Flows Overview**](./concepts/flows/overview.md)  

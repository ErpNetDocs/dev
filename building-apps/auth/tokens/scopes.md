...
Scopes are requested by the app and granted by the @@name Identity Server based on the app's configuration and policies.
...
- The @@name Identity Server verifies which scopes a **Trusted Application** is permitted to request.  

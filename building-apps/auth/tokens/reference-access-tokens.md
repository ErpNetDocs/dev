...
Reference tokens are **opaque strings** (not JWTs) that reference an internal record stored and validated by the @@name Identity Server.
...
- Are **stored securely** in the @@name Identity Server and **revocable immediately**.  

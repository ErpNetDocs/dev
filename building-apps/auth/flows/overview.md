...
All flows follow the same secure pattern, handled by @@name Identity:
...
> a **token** issued by @@name Identity that defines *who* or *what* is calling the APIs, and *what it's allowed to do*.
...
- Tokens are always issued by the instance's **Identity**.  

...
- **Consistency** – both components authenticate through the same Identity Server and share configuration via their Trusted Application.
...
flowchart LR
  subgraph Frontend[Frontend App]
    ...
    Web -->|Auth Code Flow| IDP[ERP.net Identity Server]
    IDP -->|User Token| Web
  end
